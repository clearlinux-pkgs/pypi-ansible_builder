...
Source0  : https://files.pythonhosted.org/packages/3c/d5/c94e86098107209a82de9401ec31413fabd4236af0be9427c57a5bdbf855/ansible_builder-3.1.0.tar.gz
...
%prep
%setup -q -n ansible_builder-3.1.0
cd %{_builddir}/ansible_builder-3.1.0
pushd ..
cp -a ansible_builder-3.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718919183
...
cp %{_builddir}/ansible_builder-%{version}/LICENSE.md %{buildroot}/usr/share/package-licenses/pypi-ansible_builder/1d64793d909db14ba52ed909fefa9f8cec85720d || :
