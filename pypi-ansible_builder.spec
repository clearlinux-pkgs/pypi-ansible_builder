...
Source0  : https://files.pythonhosted.org/packages/a8/a7/dd2d22da105e774c5310ddb4a422ef92675f9d5aac86855b33f30e520ba4/ansible-builder-3.0.1.tar.gz
...
%prep
%setup -q -n ansible-builder-3.0.1
cd %{_builddir}/ansible-builder-3.0.1
pushd ..
cp -a ansible-builder-3.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708544189
